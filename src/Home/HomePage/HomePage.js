        ...
        <div style={{
            ...
            <div className="pb-20 bg-[#201658] relative homepage-animated-bg">
                <div className="star-container relative z-10">
                    <div className="pt-44">
                        <div className="md:flex md:justify-center md:items-center text-center md:pt-0">
                            <div>
                                <h1 className="text-3xl md:text-4xl text-white font-bold">Our mission is to help <br /> Bangladeshi students </h1>
                                <h1 className=" text-4xl md:text-6xl text-white font-bold">study abroad</h1>
                                <p className="text-md text-white py-2">We are Working for Bangladeshi Students Study Abroad</p>
                                <motion.div whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.9 }}
                                    transition={{ type: "spring", stiffness: 400, damping: 10 }}>
                                    <button className="special-neon-btn btn text-primary hover:bg-[#400C63] px-16 mt-4 z-20 relative hover:text-white" style={{ textShadow: "0 0 .20em #FFF7, 0 0 .30em #3d40ff", boxShadow: "inset 0 0 .5em #100854, 0 0 .9em #100854" }}>i’m a student who wants study abroad</button>
                                </motion.div>
                            </div>
                        </div>
                ...
                <div className="absolute top-1/2 left-1/2 w-full h-full -translate-y-1/2 -translate-x-1/2 z-0">
                    <img src={homepageImage1} className="w-14 absolute md:w-20 top-[30%] left-[72%] rotate-12 hover:-translate-y-2 " style={{ transition: '0.5s ease-in' }} alt='' />
                    <img src={homepageImage2} className="w-14 absolute md:w-20 top-[30%] right-[72%] -rotate-12 hover:-translate-y-2 " style={{ transition: '0.5s ease-in' }} alt='' />
                    <img
                        src={homepageImage3}
                        className=" w-14 md:w-20 absolute right-[72%] top-[58%] hover:-translate-y-2" style={{ transition: '0.5s ease-in' }}
                        alt='' 
                    />
                    <img src={homepageImage4} className="absolute w-14 md:w-20 top-[58%] left-[72%] hover:-translate-y-2 " style={{ transition: '0.5s ease-in' }} alt='' />
                </div>
            </div>
        </div>
    );
